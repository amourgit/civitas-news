import { useRef, useEffect, useMemo, useState, CSSProperties, Component, ReactNode } from 'react';
import { cn } from '../../lib/utils';

// ============================================================
// Filet de sécurité WebGL : si le contexte/shader n'est pas
// disponible (appareil trop ancien, GPU désactivé...), on bascule
// sur un dégradé CSS statique plutôt que de casser la page --
// l'arrière-plan ne doit jamais être bloquant.
// ============================================================
...
class WebGLErrorBoundary extends Component<WebGLErrorBoundaryProps, WebGLErrorBoundaryState> {
  ...
  componentDidCatch(error: unknown) {
    console.error('AnimatedGradient : rendu WebGL indisponible, bascule sur le dégradé CSS.', error);
  }
...
export function AnimatedGradient({
  ...
  const params = useMemo((): PresetParams => {
    ...
    const preset = presets[config.preset] || presets.Civitas;
    return {
      ...preset,
