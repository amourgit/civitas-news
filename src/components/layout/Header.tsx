...
export const Header: React.FC<HeaderProps> = ({ children }) => {
  ...
  // taille (h-8 w-8, assortie aux autres boutons de la partie droite,
  ...
  const sidebarToggleButtonClassName =
    'flex h-8 w-8 items-center justify-center rounded-full bg-[#3B3DD9] text-white/90 hover:text-white hover:bg-[#4749e0] transition-colors duration-200';
