...
//                            (lui-même construit sur services/api/).
//
// Les composants continuent d'importer `newsService` exactement
// comme avant — aucun changement requis côté vues.
// ============================================================

import { env } from '../config/env';
import type { News, NewsType, TypeReaction } from '../types/global.types';
import { INITIAL_NEWS as MOCK_NEWS } from './api/mocks/news.mock';
import { newsRepository } from './api/repositories/news.repository';
import type { NewsQueryParams } from './api/repositories/news.repository';
