// ============================================================
// src/services/api/mocks/news.mock.ts
// Données factices du domaine News/Sujets. Ce fichier est la
// SEULE source de vérité pour ces données de démonstration —
// déplacé depuis l'ancien src/services/news.service.ts pour
// séparer clairement les DONNÉES de la LOGIQUE de service.
//
// À remplacer par de vrais appels backend dès que le domaine
// News existera côté API (voir env.useRealContentApi).
// ============================================================
...
> *"Votre avis compte directement pour l'arbitrage du budget transports qui sera présenté lors de la prochaine session académique en plénière."* — **Commission Nationale**`,
    ...
    etablissement: { id: 'etab-1', nom: 'Université Centrale & Réseau National', province: 'Estuaire' },
...
- **Plateforme Unique d'Assistance IA** hébergée localement et respectueuse de la souveraineté des données.`,
    ...
    etablissement: { id: 'etab-2', nom: 'Faculté Polytechnique & Sciences', province: 'Haut-Ogooué' },
...
- **Hackathon IA & Impact Citoyen** (48 heures chrono).`,
    ...
    etablissement: { id: 'etab-3', nom: 'Palais des Expositions & Campus Universitaires', province: 'Woleu-Ntem' },
...
3. L'intégration de produits frais et locaux issus de l'agriculture biologique régionale.`,
    ...
    etablissement: { id: 'etab-4', nom: 'Réseau National des Restaurants Universitaires', province: 'Ogooué-Maritime' },
