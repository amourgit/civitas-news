...
export const SujetMediaGallery: React.FC<SujetMediaGalleryProps> = ({
  medias,
  sujetTitre,
  defaultImage,
}) => {
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white font-display flex items-center gap-2">
              <span>Galerie Médias du Sujet</span>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">
              Vidéos, reportages, visuels et ressources de la consultation — cliquez pour agrandir
            </p>
          </div>
        </div>
